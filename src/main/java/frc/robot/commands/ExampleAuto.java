...
public class ExampleAuto extends SequentialCommandGroup {
  ...
  public ExampleAuto(Drivetrain subDrivetrain) {
    ...
    addCommands(
        ...
        new Translate(subDrivetrain, Units.Meters.of(2), Units.Degrees.of(45), Units.Percent.of(1)),
        Commands.waitSeconds(2),
        new Translate(subDrivetrain, Units.Meters.of(1), Units.Degrees.of(-45), Units.Percent.of(0.5)));
  }
}
